...
;SignTool=MsSign $f
;Encryption=yes
AppID={{938C5683-4C2B-43D8-BDC1-E98D711F4F8D}
AppName=ASCOM AMOS Dome Driver
AppVersion={#myAppVersion}
AppVerName="ASCOM AMOS Dome Driver {#myAppVersion}"
...
OutputDir="."
OutputBaseFilename="AMOS Dome Setup {#myAppVersion}"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Dome\AMOSDome"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Dome\AMOSDome"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\git\AMOSDome\bin\Release\ASCOM.AMOS.exe"; DestDir: "{app}"
...
Filename: "{app}\ASCOM.AMOS.exe"; Parameters: "/register"
...
; Only for .NET local-server drivers
Filename: "{app}\ASCOM.AMOS.exe"; Parameters: "/unregister"
