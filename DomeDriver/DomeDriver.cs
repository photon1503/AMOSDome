...
namespace ASCOM.AMOS.Dome
{
    ...
    //
    // Your driver's DeviceID is ASCOM.AMOS.Dome
    //
    // The COM Guid attribute sets the CLSID for ASCOM.AMOS.Dome
    // The COM ClassInterface/None attribute prevents an empty interface called _AMOS from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("dec478eb-3edc-4346-9fd0-148dcef4bdbd")]
    [ProgId("ASCOM.AMOS.Dome")]
    [ServedClassName("ASCOM Dome Driver for AMOS")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Dome : ReferenceCountedObjectBase, IDomeV2, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AMOS"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Dome()
        {
            try
            {
                ...
                tl = new TraceLogger("", "AMOS.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
